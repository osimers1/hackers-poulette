...
<body>
    <header>
        <img src="assets/img/chicken.png" alt="hackers chicken">
    </header>
    <blockquote>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam in tempore facilis magnam eum sunt minima? Odit, voluptas voluptates aliquam dolores ratione, quibusdam incidunt alias perferendis id similique voluptatibus a.</blockquote> 
    <img src="assets/img/raspberry-pi-3-de-stock-.jpg" alt="" id="raspberry">
    <form method="post" action="">
        <label for="name">name<br></label>
        <input type="text" name="name" placeholder="Charli">
        <br>
        ...
        <input type="email" name="email" placeholder="aze@gmail.com">
        <br>    
        <select name="pays" id="">
        ...
        <br>
        <input type="radio" name="choice" value="commande">
        <label for="commande">Commander</label>
        <br>
        <input type="radio" name="choice" value="question">
        <label for="question">Question</label>
        <br>
        <input type="radio" name="choice" value="autre">
        <label for="question">Autre</label>
        <br>
        ...
        <?php 
            ...
            if(isset($_POST['submit'])){
                ...
                if (!empty($_POST)){
                    ...
                    if(isset($name) && isset($lastname) && isset($sex) && isset($email) && isset($pays) && isset($choice) && isset($message)){
                        echo 'salut';
                    }
...
$lastname = filter_var($_POST['name'], FILTER_SANITIZE_STRING);
    $firstname = filter_var($_POST['lastname'], FILTER_SANITIZE_STRING);
    $gender = filter_var($_POST['sex'], FILTER_SANITIZE_STRING);
    $email = filter_var($_POST['email'], FILTER_SANITIZE_EMAIL);
    $country = filter_var($_POST['pays'], FILTER_SANITIZE_STRING);
    $subject = filter_var($_POST['choice'], FILTER_SANITIZE_STRING);
